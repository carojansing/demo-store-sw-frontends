...
const getDocumentDownloadEndpoint = (documentId, deepLinkCode) => `/store-api/document/download/${documentId}/${deepLinkCode}`;
const getOrderDownloadsEndpoint = (orderId, downloadId) => `/store-api/order/download/${orderId}/${downloadId}`;
const getSitemapEndpoint = () => `/store-api/sitemap`;
